...
반복되는 업무에 스트레스를 받던 차, 아내와 리프레시를 목적으로 2박 3일 짧게 다녀온 제주 여행을 기록합니다. 작년에 신혼여행으로 마지못해 다녀왔던 제주에서의 추억이 기대했던 것보다 훨씬 만족스러웠기에, 다시 찾아오게 되기까지 오래 걸리지 않았습니다. 여행을 계획할 때마다 거들떠보지도 않던 제주였는데, 이렇게 좋은 여행지라는 것을 이제라도 알게되어 다행입니다.
...
>
> 나도 저들 사이로 비집고 들어가 추위를 참아내는게 맞는걸까? 나는 어떤 인생을 살고 싶은가. 나는 그냥 더 따뜻한 남쪽으로 떠나고 싶다. 어쩌면 나는 그냥 조금 더 쉬운 인생을 살고 싶은지도 모르겠다.
...
렌트한 모델3는 FSD(Full Self Drive) 기능은 빠져있었지만 라인 트레이싱과 앞차 간격을 비롯한 기본적인 자율주행 기능만으로도 충분히 인상깊었습니다. 원래 타던 자동차가 저렴한 소형차라 그런지 내장재도 그렇게 허접해보이지 않고.. 전체적으로 만족스러웠습니다.
...
한라산 능선을 타고 숲속을 주행하는 `1139`번 도로와, 탁 트인 시야에서 느긋하게 주행할 수 있는 `1115`번 도로가 드라이브하기 참 좋았습니다.

### 오름

제주에 오면 오름이 빠질 수 없죠. 언덕 정도밖에 안돼보여도 올라가면 시야가 탁 트입니다.
...
규모는 거의 기업 수준이었습니다. 도시에 있는 가족외식점의 크기였고, 직원들분들도 많은데다 매우 분주해보였습니다. 멜젓이 나오는 상차림은 제주 스탠다드였던 것 같습니다. 고기는 적당히 맛있었던 것 같습니다. 고기에 소주 한잔이 빠질 수 없어, 한라산도 한 병 같이 곁들어서 혼자 홀짝거렸습니다. 차를 가져와서 아내와 함께 마실 수 없음이 아쉬웠습니다.
